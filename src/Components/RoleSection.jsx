...
const roles = [
  {
    ...
    description: 'Build responsive, interactive user interfaces using modern frameworks and libraries.',
  ...
  },
  {
    ...
    description: 'Create robust APIs, manage databases, and build server-side applications.',
  ...
  },
  {
    ...
    description: 'Design intuitive user experiences and beautiful interfaces for web and mobile.',
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Select a professional path that matches your skills and interests. Each role offers unique challenges and learning opportunities.
          </p>
        </div>
