...
const integrations = [
  ...
  },
  {
    ...
    features: ['Task synchronization', 'Progress tracking', 'Deadline management'],
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Connect with the tools you already use to enhance your learning experience and streamline your workflow.
          </p>
        </div>
          ...
          {integrations.map((integration, index) => (
            ...
            >
              ...
              {integration.features.map((feature, i) => (
                <div key={i} className={`flex items-center text-sm text-gray-500 ${i > 0 ? 'mt-2' : ''}`}>
