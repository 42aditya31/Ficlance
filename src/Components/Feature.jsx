...
const levels = [
  ...
  },
  {
    ...
    badges: [
      { icon: <RiStarFill className="text-yellow-500" />, bg: 'bg-yellow-100' },
      { icon: <RiCodeBoxLine className="text-purple-500" />, bg: 'bg-purple-100' },
    ],
  },
  {
    status: 'locked',
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Your Personalized Learning Journey</h2>
            <p className="text-lg text-gray-600 mb-6">
              Track your progress through increasingly complex projects that build both technical and soft skills
              essential for freelancing success.
            </p>
              ...
              <div className="bg-white border border-gray-200 rounded-xl shadow-md p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="ml-2 text-sm font-medium text-gray-700">Level 3</span>
                  </div>
                </div>
                      ...
                      <div className="flex items-center mb-2">
                        ...
                        <div className="ml-3">
                          <h4
                            className={`font-medium ${
                              lvl.status === 'locked' ? 'text-gray-500' : 'text-gray-900'
                            }`}
                          >
                            {lvl.title}
                          </h4>
                          <p
                            className={`text-sm ${
                              lvl.status === 'locked' ? 'text-gray-400' : 'text-gray-600'
                            }`}
                          >
                            {lvl.subtitle}
                          </p>
                        ...
                        <div className="ml-auto flex">
                          {lvl.badges.map((b, j) => (
                            <div
                              key={j}
                              className={`w-8 h-8 rounded-full ${b.bg} flex items-center justify-center ${
                                j > 0 ? 'ml-2' : ''
                              }`}
                            >
                              {b.icon}
