...
const ProjectCard = ({
  ...
  return (
    ...
    >
      ...
      <div className={`h-40 bg-gradient-to-br ${gradientColors} relative overflow-hidden`}>
        {/* Duration badge */}
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-5">
          {technologies.map((tech, index) => (
            <span
              key={index}
              className={`px-2.5 py-1 ${getTechnologyColor(tech)} rounded-lg text-xs font-medium`}
            >
              {tech}
            </span>
          ))}
